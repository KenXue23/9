...
bgImage = PhotoImage(file='C:/Users/kx063/OneDrive/桌面/91906/assest/bg2.png')

bgLabel = Label(signup_window, image=bgImage)
bgLabel.place(x=0, y=0)

label = Label(signup_window, text='CREATE AN ACCOUNT', font=('Comic Sans MS', 23, 'bold'),
              background='#C2EBAA', foreground='Limegreen')
label.place(x=125, y=300)

usernameEntry = Entry(signup_window, width=22, font=('Comic Sans MS', 20, 'bold'), bd=0,
                      foreground='Limegreen', background='#C2EBAA', highlightbackground='#C2EBAA')
...
emailEntry = Entry(signup_window, width=22, font=('Comic Sans MS', 20, 'bold'), bd=0,
                      foreground='Limegreen', background='#C2EBAA', highlightbackground='#C2EBAA')
...
passwordEntry = Entry(signup_window, width=22, font=('Comic Sans MS', 20, 'bold'), bd=0,
                      foreground='Limegreen', background='#C2EBAA', highlightbackground='#C2EBAA')
...
confirm_passwordEntry = Entry(signup_window, width=22, font=('Comic Sans MS', 20, 'bold'), bd=0,
                             foreground='Limegreen', background='#C2EBAA', highlightbackground='#C2EBAA')
...
image_path = 'C:/Users/kx063/OneDrive/桌面/91906/assest/signup.png'
button_image = Image.open(image_path).convert("RGBA")
button_image = button_image.resize((330, 100), Image.ANTIALIAS)
button_photo = ImageTk.PhotoImage(button_image)

signup_button = Button(signup_window, image=button_photo, bd=0, cursor="hand2",highlightthickness=0,
                       bg='white', activebackground='#C2EBAA', command=connect_database)
signup_button.place(x=135, y=660)

loginLabel = Label(signup_window, text='Already have an account?', font=('Comic Sans MS', 15, 'bold'),
                   background='#C2EBAA', foreground='Limegreen')
loginLabel.place(x=170, y=770)

loginLink = Label(signup_window, text='Click here to login', font=('Comic Sans MS', 15, 'bold', 'underline'),
                  background='#C2EBAA', foreground='blue')
