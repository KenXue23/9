...
searchbar = ImageTk.PhotoImage(Image.open('C:/Users/kx063/OneDrive/桌面\91906(v1)/assest/Rounded Rectangle.png').resize((500, 80)), Image.ANTIALIAS)
searchbaricon = ImageTk.PhotoImage(Image.open('C:/Users/kx063/OneDrive/桌面\91906(v1)/assest/Layer 7.png').resize((65, 50)), Image.ANTIALIAS)
search = ImageTk.PhotoImage(Image.open('C:/Users/kx063/OneDrive/桌面\91906(v1)/assest/search.png').resize((65, 65)), Image.ANTIALIAS)
inforectangle = ImageTk.PhotoImage(Image.open('C:/Users/kx063/OneDrive/桌面\91906(v1)/assest/rectangle.png').resize((500, 280)), Image.ANTIALIAS)
forecastrectangle = ImageTk.PhotoImage(Image.open('C:/Users/kx063/OneDrive/桌面\91906(v1)/assest/rectangle2.png').resize((614, 700)), Image.ANTIALIAS)
firstbox = ImageTk.PhotoImage(Image.open('C:/Users/kx063/OneDrive/桌面\91906(v1)/assest/info3.png').resize((170, 350)), Image.ANTIALIAS)
secondbox = ImageTk.PhotoImage(Image.open('C:/Users/kx063/OneDrive/桌面\91906(v1)/assest/info2.png').resize((100, 150)), Image.ANTIALIAS)
...
menuopen = ImageTk.PhotoImage(Image.open('C:/Users/kx063/OneDrive/桌面\91906(v1)/assest/menuopen.png').resize((50, 50), Image.ANTIALIAS))
menuclose = ImageTk.PhotoImage(Image.open('C:/Users/kx063/OneDrive/桌面\91906(v1)/assest/menuclose.png').resize((50, 50), Image.ANTIALIAS))
logo = ImageTk.PhotoImage(Image.open('C:/Users/kx063/OneDrive/桌面\91906(v1)/assest/logo.png').resize((200, 100), Image.ANTIALIAS))
